...
namespace keshe
{
    public partial class updateBookClass : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("update bookclass set bkC='"+textBox1.Text+"' where bcNum="+_List[comboBox1.SelectedIndex], con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            this.Close();
        ...
        private void updateBookClass_Load(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(Common.Con);
